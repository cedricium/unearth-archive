<template>
  <div data-v-4c674db3="" id="user-site"><div data-v-4c674db3="" class="template-container"><div data-v-4c674db3="" class="black-white font-neutral"><!---->
    <header class="header"><div data-v-2641a901="" class="container-lrg"><div data-v-2641a901="" class="flex col-12 spread">
      <nuxt-link to="/">
        <a data-v-2641a901="" class="logo launchaco-builder-hoverable logo"><img data-v-2641a901="" src="https://cdn.launchaco.com/images/ec28e821-87e4-41ec-af07-bd0fc50f9a2e.png" alt="unearthCompany Logo"><span>unearth</span></a>
      </nuxt-link>
      <a data-v-2641a901="" href="mailto:" class="nav-link secondary-color mr0">Contact</a></div></div>
    </header> <section class="section"><div class="container mb40"><div class="col-12 text-center"><h1 class="heading-lrg primary-color launchaco-builder-hoverable">Uh-oh!</h1> <h2 class="subheading secondary-color mt20 launchaco-builder-hoverable">Looks like you're lost...</h2>
    <div class="mt40">
      <nuxt-link to="/">
        <a href="https://www.tryunearth.com" target="_blank" class="button mobile-text-center mt10 launchaco-builder-hoverable mobile-text-center accent-bg primary-color"> <span> Back to homepage </span></a>
      </nuxt-link>
    </div></div></div> <!----></section></div> <!----></div>
    <div data-v-4c674db3="" class="template-container"><footer data-v-4c674db3="" id="footer-3" class="section text-center black-flat font-neutral" activepage="Landing" sitemeta="[object Object]"><div class="container col-12"><nav class="mb50"><a target="_blank" href="https://twitter.com/cedricamaya" class="nav-link secondary-color">Being built 🛠 by Cedric Amaya</a></nav> <div><a href="https://twitter.com/tryunearth" target="_blank" class="socialicons accent-bg twitter"></a><a href="https://facebook.com/tryunearth" target="_blank" class="socialicons accent-bg facebook"></a><a href="mailto:hello@tryunearth.com" class="socialicons accent-bg email"></a></div> <!----></div></footer> <!----></div>
  </div>
</template>
